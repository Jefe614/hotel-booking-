"""
Django settings for bava project.
...
SECRET_KEY = 'django-insecure-4-=v%%!c@k#sym^m(7b8o01_501g9)$)$#$aygxijwdpdwfhmu'
...
WSGI_APPLICATION = 'bava.wsgi.application'
...
TABLE_RESERVATION_DEPOSIT = 1000 